...
public final class DubboProviderDetector implements ApplicationTypeDetector {
    ...
    private static final String DEFAULT_BOOTSTRAP_MAIN = "org.apache.dubbo.container.Main";

    private static final String REQUIRED_CLASS = "org.apache.dubbo.rpc.proxy.AbstractProxyInvoker";
